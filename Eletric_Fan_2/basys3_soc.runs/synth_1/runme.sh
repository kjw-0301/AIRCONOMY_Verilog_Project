...
HD_PWD='C:/Users/minkyu/Documents/GitHub/AIRCONOMY_Verilog_Project/Eletric_Fan_2/basys3_soc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module_of_electric_fan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_module_of_electric_fan.tcl
